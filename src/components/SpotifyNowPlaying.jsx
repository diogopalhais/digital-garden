...
export default function SpotifyNowPlaying() {
    ...
    return (
      <div className="p-6 pt-2">
        <div className="flex items-center gap-5">
          <div className="h-20 w-20 animate-pulse rounded-xl bg-border" />
      ...
      <div className="p-6 pt-2">
        <div className="flex items-center gap-5">
          ...
          <div className="flex-1">
            ...
            <p className="mt-1 text-sm text-text-muted">Not listening to anything right now</p>
          </div>
        </div>
      </div>
    );
  ...
  return (
    <a
      ...
      className="group block p-6 pt-2 transition-all"
    >
      <div className="flex items-center gap-5">
        {/* Album Art */}
        ...
        <div className="min-w-0 flex-1">
          <p className="truncate text-base font-bold text-text-primary transition-colors duration-300 group-hover:text-[#1DB954]">
            {data.title}
          </p>
          <p className="mt-1 truncate text-sm text-text-secondary">{data.artist}</p>
          <p className="mt-0.5 truncate text-xs text-text-muted">{data.album}</p>
        </div>
